...
int main()
{
	...
	do
	{
		...
		if (test)
		{
			...
			std::cout << "  [0] No create file (data save RAM, fast)\n";
			std::cout << "  [1] Create file (data save FILE, slow)\n";
			std::cout << "  [2] Ñancel test\n";
			std::cout << "input: ";
			std::cin >> flag_file;
			if (flag_file == 0)
			{
